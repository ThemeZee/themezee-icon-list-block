...
if ( ! class_exists( 'ThemeZee_Blocks_Admin_Page' ) ) :
	...
	class ThemeZee_Blocks_Admin_Page {
		...
		static function add_settings_page() {
			add_options_page(
				esc_html__( 'ThemeZee Blocks', 'themezee-icon-list-block' ),
				esc_html__( 'ThemeZee Blocks', 'themezee-icon-list-block' ),
				'manage_options',
				'themezee-blocks',
		...
		static function render_settings_page() {
			...
			<div class="wrap">
				...
				<h1><?php esc_html_e( 'ThemeZee Blocks', 'themezee-icon-list-block' ); ?></h1>
		...
		static function register_settings() {
			...
			add_settings_section(
				...
				esc_html__( 'License Settings', 'themezee-icon-list-block' ),
		...
		static function license_section_intro() {
			esc_html_e( 'An active license key is needed to install updates and receive support.', 'themezee-icon-list-block' );
		}

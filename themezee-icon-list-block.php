 ...
 * Description:       Create an icon list.
 ...
 * Text Domain:       themezee-icon-list-block
 *
...
include dirname( __FILE__ ) . '/includes/class-themezee-icon-list-block-license-settings.php';
include dirname( __FILE__ ) . '/includes/class-themezee-icon-list-block-updater.php';
 ...
 */
function update_themezee_icon_list_block() {
	...
	$edd_updater = new ThemeZee_Icon_List_Block_Updater(
		...
		__FILE__,
		array(
			'version' => THEMEZEE_ICON_LIST_BLOCK_VERSION,
			'license' => $license_key,
...
add_action( 'init', 'update_themezee_icon_list_block' );
